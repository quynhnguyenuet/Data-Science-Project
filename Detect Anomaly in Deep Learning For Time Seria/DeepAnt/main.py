...
from deepant_new_data.inference import InferenceRunner
...
def main():
    ...
    logger.info(f"DeepAnT running in mode: {config.mode}")
    ...
    if config.mode == "train":
        ...
        logger.error("Invalid mode in config. Use 'train' or 'inference'.")
